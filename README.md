...
| --- | --- | --- | --- |
| Frontend | React | 19.1 | Component rendering |
| Frontend | Zustand | 5.0 | State management (2 stores) |
| Frontend | TypeScript | 5.8 | Type safety |
| Frontend | Vite | 7.0 | Build + HMR |
| Backend | Rust | 2021 ed. | Performance-critical core |
| Backend | Tauri | 2.x | Desktop shell + IPC |
| Backend | quick-xml | 0.36 | Streaming XML parser |
| Backend | rusqlite | 0.31 | SQLite (bundled, zero config) |
| Backend | thiserror | 1.x | Typed error propagation |
| Infra | GitHub Actions | — | CI/CD → cross-platform installers |
| Infra | tauri-plugin-dialog | 2.x | Native file open/save dialogs |
| Infra | tauri-plugin-fs | 2.x | Filesystem access |
...
*Built with obsessive attention to performance by a developer who was tired of bad XML editors.*
